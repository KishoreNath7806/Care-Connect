...
export const metadata = {
    title: 'Admin Dashboard - Care Connect',
    description: 'Manage and oversee the Care Connect platform with the Admin Dashboard.',
}
    ...
    <div className='container mx-auto px-4 py-8'>
        ...
        <Tabs defaultValue="pending" className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <TabsList className="md:col-span-1 bg-muted/30 border h-14 md:h-28 flex sm:flex-row md:flex-col w-full p-2 md:p-1 rounded-md md:space-y-2 sm:space-x-2 md:space-x-0">
                <TabsTrigger value="pending" className="flex-1 md:flex md:items-center md:justify-start md:px-4  md:py-3 w-full data-[state=active]:bg-blue-600 data-[state=active]:text-white">
                    <AlertCircle className="h-4 w-4 mr-2 hidden md:inline" />
                    <span>Pending Status</span>
                </TabsTrigger>
                <TabsTrigger value="doctors" className="flex-1 md:flex md:items-center md:justify-start md:px-4  md:py-3 w-full data-[state=active]:bg-blue-600 data-[state=active]:text-white">
